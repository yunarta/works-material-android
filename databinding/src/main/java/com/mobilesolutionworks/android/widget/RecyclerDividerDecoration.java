...
public class RecyclerDividerDecoration extends RecyclerView.ItemDecoration
{
    ...
    public RecyclerDividerDecoration(Context context, int orientation)
    {
        final TypedArray a = context.obtainStyledAttributes(new int[]{
                context.getResources().getIdentifier("listDivider", "attr", "android")
        });
    ...
    public RecyclerDividerDecoration(Context context, int orientation, ColorDrawable drawable)
    {
        mDivider = drawable;
        setOrientation(orientation);
    }
    ...
    public void drawVertical(Canvas c, RecyclerView parent)
    {
        ...
        intrinsicHeight = (intrinsicHeight == -1) ? 1 : intrinsicHeight;
